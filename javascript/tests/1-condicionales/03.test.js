const {calificaciones} = require("../../ejercicios/1-condicionales/03.js")

describe('Evaluar calificaciones', function() {
    ...
    it('Calificacion invalida', function() {
        expect(calificaciones(12)).toBe("Calificación invalida");
        expect(calificaciones(-10)).toBe("Calificación invalida");
    });
});
